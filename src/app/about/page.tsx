    ...
    return (
      <div className="flex flex-col p-6 space-y-3">
          <section className="space-y-1">
            ...
            <p>I have just finished a ten-week intensive <span className="text-neutral-400">Software Engineering</span> Bootcamp with <span className="text-neutral-400">Northcoders</span> and am looking for <span className="text-neutral-400">Junior</span> or <span className="text-neutral-400">Entry-level</span> roles in <span className="text-neutral-400">Sheffield</span> or <span className="text-neutral-400">Remote</span>.</p>

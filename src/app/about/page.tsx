    ...
    return (
      <section className="flex flex-col align-center bg-neutral-950">
        <section className="p-6 space-y-1">
          ...
          <p>Check out my <Link href="/projects" className="underline decoration-purple-300 text-purple-300">projects</Link> or send a message via the <Link href="/about" className="underline decoration-purple-300 text-purple-300">contact</Link> page if you'd like a chat.</p>
        </section>

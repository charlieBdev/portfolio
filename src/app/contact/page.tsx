...
export default function Contact() {
	...
	return (
		<section className="min-h-screen p-6 xl:px-24 flex flex-col lg:flex-row xl:flex-col lg:justify-between xl:justify-start xl:mx-auto xl:items-center space-y-6">

    ...
    return (
      <main className="flex flex-col bg-neutral-950">
        <section className="p-6 space-y-1">
          ...
          <p>There you can find my latest projects such as <Link href="https://aa-sound-waves.vercel.app/" target="_blank" className="underline decoration-purple-300 text-purple-300">SoundWaves</Link> and <Link href="https://euphonious-scone-36cbae.netlify.app/" target="_blank" className="underline decoration-purple-300 text-purple-300">NC News</Link>.</p>
        </section>
      </main>
    )
}

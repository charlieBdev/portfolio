...
export default function Navbar() {
  return (
    <header>
      <nav 
        className="px-6 xl:px-24 flex items-center justify-between border-b border-neutral-200 dark:border-neutral-800 fixed top-0 right-0 left-0 h-24 shadow-xl bg-opacity-60 backdrop-blur dark:bg-opacity-60 dark:backdrop-blur"
      >

...
export default function Navbar() {
	return (
		<header className="">
			<nav className="fixed top-0 left-0 right-0 px-6 h-24 xl:px-24 flex items-center justify-between border-b border-neutral-200 dark:border-neutral-800 shadow-xl bg-opacity-90 backdrop-blur dark:bg-opacity-90 dark:backdrop-blur z-10">

...
export default function Footer() {
    ...
    return (
        <footer className={`mt-auto flex justify-between items-center py-3 px-6 xl:px-24 border-t border-neutral-600 fixed bottom-0 left-0 right-0 h-16 text-black bg-white dark:text-white dark:bg-black`}>

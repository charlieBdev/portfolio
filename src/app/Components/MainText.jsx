...
export const MainText = () => {
	...
	return (
		<div className='h-[calc(100vh-5rem)] mt-20 flex flex-col items-center justify-center gap-3 select-none p-6 xl:px-24 xl:items-center hover:cursor-pointer overflow-hidden'>
			<motion.div drag>
